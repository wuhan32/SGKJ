<template>
  ...
  <div class="Adaptive">
      ...
      <ul class="Adaptive-header-right">
        <li>
          <ul>
            ...
            <li>
              ...
              <div>
                <!-- <input type="checkbox" v-model="adapterCheck" @change="Setvadapterr" /> -->
                <input
                  type="text"
        ...
        <li>
          <ul>
            ...
            <li>AC/KF</li>
            <li>AC/KS</li>
            <li style="border-right: none">片径/OAD</li>
          </ul>
          <ul>
            <li>
              <input
          ...
          <ul>
            ...
            <li>
              ...
              >
                ...
                <el-checkbox label="120"></el-checkbox>
              </el-checkbox-group>
              <div>
                <span>其它</span>
                <input
    ...
    <footer v-show="examCategory == 60">
      <p>结论</p>
      <div style="border-right: 1px solid #ccc">
        <el-checkbox-group v-model="savemessage.checkList">
          <el-checkbox label="143" style="width: 150px !important"
            >可以定镜</el-checkbox
          >
          <el-checkbox label="144" style="width: 150px !important"
            >再次试戴</el-checkbox
          >
          <el-checkbox label="145" style="width: 150px !important"
            >转诊上交</el-checkbox
          >
        </el-checkbox-group>
      </div>
      <div style="border-right: 1px solid #ccc">
        <el-checkbox-group v-model="savemessage.checkList">
          <el-checkbox label="146" style="width: 150px !important"
            >可以定镜</el-checkbox
          >
          <el-checkbox label="147" style="width: 150px !important"
            >再次试戴</el-checkbox
          >
          <el-checkbox label="148" style="width: 150px !important"
            >转诊上交</el-checkbox
          >
        </el-checkbox-group>
      </div>
      ...
      if (res.code == 0) {
        ...
        strArr.forEach((res) => {
          switch (res) {
            // case "doctor":
            //   {
            //     let msg = `【${this.$store.state.userInfo.TrueUserName}】已将【${this.$store.state.target.name}】分配至您的检查队列中：`;
