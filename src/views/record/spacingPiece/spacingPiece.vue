  ...
  <div class="spacing">
    <header>
      ...
      <div class="header-right">
        <!-- <input type="text" v-model="savemessage.inputList.verifierCheck" maxlength="16" disabled />
        填单人:
    ...
    <table>
      <tr>
        <td colspan="2" style="width: 200px">患者姓名</td>
        <td>
        ...
        <td colspan="5">
          <input
            ...
            name
            id
            v-model="savemessage.inputList.inputList8"
          />
        </td>
      </tr>
      <tr>
        ...
        <td rowspan="2">眼别</td>
        <td rowspan="2" style="width: 336px">屈光处方</td>
        <td colspan="3">BC</td>
        <td colspan="2">AC</td>
        <td rowspan="2">OAD</td>
        <td rowspan="2">片色</td>
      ...
      <tr>
        ...
        <td>
          <el-select v-model="savemessage.inputList.dropDown22" size="mini">
            <el-option label="追梦莱特" value="2074">追梦莱特</el-option>
            <el-option label="欧几里德" value="2075">欧几里德</el-option>
            <el-option label="阿尔法" value="2076">阿尔法</el-option>
          </el-select>
...
export default {
  ...
  methods: {
    ...
    //查看病例信息
    async getExamDetail() {
      this.adapterCheck = false; //获取信息的时候重置参数值
      this.verifierCheck = false;
      this.voluntarilyFlag = false;
